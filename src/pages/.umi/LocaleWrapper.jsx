...
const localeInfo = {
  'en-US': {
    messages: {
      ...require('C:/项目包/项目包/2019-react-Project/antdesign-pro/my-project/src/locales/en-US.js').default,
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...require('C:/项目包/项目包/2019-react-Project/antdesign-pro/my-project/src/locales/pt-BR.js').default,
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...require('C:/项目包/项目包/2019-react-Project/antdesign-pro/my-project/src/locales/zh-CN.js').default,
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...require('C:/项目包/项目包/2019-react-Project/antdesign-pro/my-project/src/locales/zh-TW.js').default,
    },
    locale: 'zh-TW',
